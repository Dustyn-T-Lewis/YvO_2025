...
#                         FIG_THEME, RPT_DIR, DAT_DIR, KEY_TEXT, KEY_TITLE
...
if (!exists("sig_sets")) source("05_Figures/F1/a_script/panel_D.R")
...
# Count mixed-direction proteins
...
# Fisher's exact test for pairwise overlap enrichment
overlap_tests <- list()
