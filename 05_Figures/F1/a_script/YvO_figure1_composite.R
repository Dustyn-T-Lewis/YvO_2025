...
source("05_Figures/F1/a_script/panel_A.R")     # -> pA
source("05_Figures/F1/a_script/panel_B.R")     # -> pB
source("05_Figures/F1/a_script/panel_C.R")     # -> pC, pC_key
source("05_Figures/F1/a_script/panel_D.R")     # -> pD  (+ sig_sets, dir_map for E)
source("05_Figures/F1/a_script/panel_E.R")     # -> pE_bars, pE_dots, pKeys
source("05_Figures/F1/a_script/panel_F.R")     # -> pF
source("05_Figures/F1/a_script/supp_S1_7.R")   # -> s17
