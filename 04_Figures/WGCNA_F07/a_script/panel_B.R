...
# Three-part layout: counts | color sidebar | heatmap with trait category gaps
...
# Drop BMI (baseline only, not informative)
...
# Supplementary cor.test() CIs for pairwise-complete n (stat audit)
audit_traits <- meta %>%
  mutate(
