...
fcm_path <- "04_Figures/F06/c_data/06_mfuzz_assignments.csv"
...
conc_path <- "04_Figures/F04/c_data/panel_C/concordance.csv"
...
rev_path <- "04_Figures/F05/c_data/panel_C/reversal_scatter.csv"
