...
# --- Short count-only labels ---
LABELS_DOWN <- c(
  Aging          = "118 proteins lower in older vs young",
  Training_Young = "56 proteins dec. with training",
  Training_Old   = "10 proteins dec. with training",
  Interaction    = "5 proteins with greater Young response"
)
LABELS_UP <- c(
  Aging          = "80 proteins higher in older vs young",
  Training_Young = "43 proteins inc. with training",
  Training_Old   = "8 proteins inc. with training",
  Interaction    = "29 proteins with greater Old response"
)
...
pD_2x2 <- (p_tr_y | p_aging) / (p_tr_o | p_inter) +
  plot_annotation(
