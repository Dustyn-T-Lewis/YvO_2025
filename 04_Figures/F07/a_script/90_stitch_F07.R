...
if (dir.exists(BOX)) {
  ...
  for (d in file.path(box_f07, c("main/pdf", "main/png", "supp/pdf", "supp/png")))
    dir.create(d, recursive = TRUE, showWarnings = FALSE)
  file.copy(file.path(RPT, "main/pdf/MAIN_F07_composite.pdf"),
            file.path(box_f07, "main/pdf/MAIN_F07_composite.pdf"), overwrite = TRUE)
  file.copy(file.path(RPT, "main/png/MAIN_F07_composite.png"),
            file.path(box_f07, "main/png/MAIN_F07_composite.png"), overwrite = TRUE)
  file.copy(file.path(RPT, "supp/pdf/SUPP_F07_composite_main.pdf"),
            file.path(box_f07, "supp/pdf/SUPP_F07_composite_main.pdf"), overwrite = TRUE)
  file.copy(file.path(RPT, "supp/pdf/SUPP_F07_composite_loso.pdf"),
            file.path(box_f07, "supp/pdf/SUPP_F07_composite_loso.pdf"), overwrite = TRUE)
  file.copy(file.path(RPT, "supp/png/SUPP_F07_composite.png"),
            file.path(box_f07, "supp/png/SUPP_F07_composite.png"), overwrite = TRUE)
