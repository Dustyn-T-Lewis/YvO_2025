...
#   Generates: panel_E_heatmap.pdf/png, 05_panel_E_heatmap.csv
################################################################################
#
...
# --- Text sizes ---
txt_cell  <- scale_text(BASE_GENE, PE_W) * 0.5  # very small for heatmap cells
txt_gene  <- scale_text(BASE_GENE, PE_W) * 0.7  # gene names on y-axis
