...
#   Source: 04_Figures_v1/F5/YvO_WGCNA_run.R (all analysis preserved)
#
#   Workflow:
...
#
#   Outputs → 04_Figures_v2/F5/c_data/wgcna/
...
#
#   Reports → 04_Figures_v2/F5/b_reports/wgcna/
...
REPORT_DIR <- "04_Figures_v2/F5/b_reports/wgcna"
DATA_DIR   <- "04_Figures_v2/F5/c_data/wgcna"
...
#
# BH correction scope: GLOBAL across all modules x all traits.
# nModules x nTraits = nrow(module_trait_pval) x ncol(module_trait_pval) tests.
# ─────────────────────────────────────────────────────────────────────────────
...
# Background = all proteins in datExpr (full universe)
...
# Soft-threshold summary for Methods reporting (Langfelder & Horvath 2017)
sft_summary <- tibble(
