...
#   Generates: panel_C_triptych.pdf/png, c_data/03_panel_C_*.csv,
#              c_data/07_module_reversal.csv, c_data/08_age_gap_closure.csv,
#              age_gap_closure.pdf
################################################################################
#
# -- STAT AUDIT (2026-02-27) --------------------------------------------------
# EIGENGENE REVERSAL (Phase 4a): paired t-test with Shapiro-Wilk normality
#   check and Wilcoxon signed-rank sensitivity.  BH across age-associated modules.
# AGE GAP CLOSURE (Phase 4b): Wilcoxon signed-rank with Hodges-Lehmann CI.
# GO ENRICHMENT BARS: BH-corrected per module (standard ORA).
# SANKEY: Greedy 1:1 assignment (non-inferential).
# -----------------------------------------------------------------------------
...
# Annotation columns for gene lookups
...
# --- Module eigengene reversal (paired t-test with normality check) ---
