# ── F3 prepare_data.R: Heavy-compute reversal tests + fGSEA cache ────────────
# Run BEFORE panel scripts. Saves intermediates to c_data/.
# - Melov permutation reversal test (10,000 permutations)
# - Reversal contingency table + Fisher's exact test
# - Signed reversal score
# - Reversal fGSEA (if not in cache)
# - Melov histogram figure
...
message("Computing Melov permutation reversal test...")
...
message("Computing reversal contingency table...")
...
message("Computing signed reversal score...")
