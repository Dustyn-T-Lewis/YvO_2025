...
#   Standalone legends for F2 training response panels
################################################################################

source("04_Figures_v2/keys/extract_keys.R")

message("Building F2 keys...")

# --- Direction colors legend (volcano rings) ---
dir_df <- tibble(
...
# --- Age colors legend (concordance scatter) ---
age_df <- tibble(
