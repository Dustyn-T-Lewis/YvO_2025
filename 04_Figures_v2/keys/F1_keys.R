...
#   Standalone legends for F1 proteomic landscape panels
################################################################################

source("04_Figures_v2/keys/extract_keys.R")

message("Building F1 keys...")

# --- Group fill legend (used by CV violins, Panel A) ---
group_df <- tibble(
...
# --- Contrast colors legend (used by logFC density, Panel B) ---
ctr_df <- tibble(
...
# --- PCA color/shape legend (Panel C) ---
pca_df <- tibble(
...
# --- Direction colors legend (used by fGSEA, UpSet; Panel E, F) ---
dir_df <- tibble(
