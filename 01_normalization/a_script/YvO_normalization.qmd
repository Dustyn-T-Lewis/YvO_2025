...
data (Lazar et al., 2016). A 66% completeness threshold per condition
(`Group_Time`) ensures that retained proteins have sufficient data for
reliable statistical inference. With 15–17 subjects per condition, 66%
requires detection in at least 10–11 samples — a stringent but
appropriate threshold for this well-powered dataset
