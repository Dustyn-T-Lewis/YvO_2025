#!/usr/bin/env Rscript
# apply_missforest.R — Apply missForest to normalized matrix
#
# Replaces the internal benchmark + imputation steps of 01_run_imputation.R.
...
#   c_data/01_imputed.csv           — imputed matrix with annotation
...
# --- Palettes (for report intermediates) -------------------------------------
...
# --- 3. MAR/MNAR classification (same logic as 01_run_imputation.R) ----------
...
# --- 5. Export (same format as 01_run_imputation.R) --------------------------
was_na <- is.na(mat)
best <- "missForest"
